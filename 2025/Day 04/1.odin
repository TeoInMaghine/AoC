// I did so many of these kinds of problems and this one is so easy that I
// didn't even have to think about how to do it lol.
...
main :: proc() {
    ...
    for neigh_column, row in neighs {
        for neigh, col in neigh_column {
            if is_roll[row][col] && neigh < 4 do accessible_rolls += 1
        }
    }
    fmt.println(accessible_rolls)
}
